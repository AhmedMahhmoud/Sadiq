                  ...
                  Column(
                    children: [
                          ...
                          Expanded(
                            child: CustomTextField(
                              ...
                              onSaved: (p0) => authCubit
                                  .registerInputsBuilder.firstName = p0!,
                            ),
                          ),
                      ...
                      CustomTextField(
                        hintText: 'رقم الجوال',
                        validator: (p0) {
                          if (!RegexHandling.validatePhoneRegexHandler(p0!)) {
                      ...
                      CustomTextField(
                        ...
                        validator: (p0) {
                          if (!RegexHandling.validateEmailRegexHandler(p0!)) {
                      ...
                      CustomTextField(
                        ...
                        textInputAction: TextInputAction.next,
                        validator: (p0) {
                          if (!RegexHandling.validateIdentityCard(p0!, 'EG')) {
                      ...
                      InkWell(
                        onTap: () {
                          BottomPicker.date(
                            ...
                            onSubmit: (index) {
                              authCubit.registerInputsBuilder.dateofBirth =
